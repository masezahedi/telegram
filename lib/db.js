...
async function openDb() {
  ...
  await db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS forwarding_services (
      ...
      created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
      activated_at DATETIME, -- This might be redundant now or used for last activation
      service_activated_at DATETIME, -- New: For 15-day expiry from FIRST activation
