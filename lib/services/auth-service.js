...
const AuthService = {
      ...
      if (data.success && typeof window !== "undefined") {
        ...
        localStorage.setItem(
          ...
          JSON.stringify({
            ...
            premiumExpiryDate: premium_expiry_date, // Store directly from API
            trialActivatedAt: trial_activated_at, // Store directly from API
  ...
  getStoredUser() {
    try {
      ...
      return {
        ...user,
        // اینها اکنون به طور مستقیم از localStorage خوانده می‌شوند
