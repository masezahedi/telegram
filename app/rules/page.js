...
const rulesSections = [
  ...
  },
  {
    ...
    items: [
      "کاربران متعهد می‌شوند که از این سرویس برای مدیریت، فوروارد یا کپی هرگونه محتوای غیرقانونی، غیراخلاقی، توهین‌آمیز، کلاهبرداری، اسپم، دارای کپی‌رایت و ناقض حریم خصوصی دیگران استفاده نکنند.",
